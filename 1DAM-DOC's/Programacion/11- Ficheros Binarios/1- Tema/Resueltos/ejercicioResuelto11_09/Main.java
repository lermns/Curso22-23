package tema11.ejerciciosResueltos.ejercicioResuelto11_09;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		Socio[] arrSocios = {new Socio(5,"Pepe",LocalDate.of(2000, 12, 22)),
				 ...
				 new Socio(3,"Ana",LocalDate.of(2000, 10, 20)),
				 new Socio(9,"Raul",LocalDate.of(2005, 3, 7)),
				 new Socio(1,"Carla",LocalDate.of(2001, 2, 15)),
