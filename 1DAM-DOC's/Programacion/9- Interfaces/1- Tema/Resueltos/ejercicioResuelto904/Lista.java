...
import tema9.ejerciciosResueltos.ejercicioResuelto903.Pila;
...
public class Lista implements Cola, Pila{
	...
	public void eliminarPosicion( int intPos) {
		if(intPos>=0 && intPos<this.intArrLista.length) {
...
*/
	public Integer elemento( int intPos) {
		...
		return intPos>=0 && this.intArrLista.length>intPos?this.intArrLista[intPos]:null;
	}
...
*/		return devolver;
	...
	public void push(int intElemento) {
		this.insertarFinal(intElemento);
	}

	@Override
	public void pushPila(int intElemento) {
		this.insertarPrincipio(intElemento);
	}	
}
